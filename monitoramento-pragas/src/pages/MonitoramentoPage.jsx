...
import { FaSeedling, FaHome, FaTractor, FaBug, FaEye, FaSearch, FaRefresh } from "react-icons/fa";
      ...
      <div className="flex min-h-screen bg-[#f5f8f2] text-gray-800">
        ...
        <main className="flex-1 p-10 flex items-center justify-center">
          <div className="text-center">
            <FaRefresh className="animate-spin text-4xl text-green-600 mx-auto mb-4" />
